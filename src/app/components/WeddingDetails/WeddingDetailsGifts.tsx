    ...
    return (
        <section className="pb-[90px] md:pb-[110px]">
            ...
            <div data-aos="fade-up" data-duration="1500" className="mb-[50px]">
                <i className="text-[#2D2D2D] fa-regular fa-envelope text-[80px] md:text-[60px] mb-[25px] md:mb-0" />
                <h2 className="uppercase font-semibold text-[18px] md:text-[19px] text-[#2D2D2D] tracking-[1px] md:tracking-[1.5px] leading-[27px] md:leading-[28.5px]">Caja de sobres</h2>
            </div>
